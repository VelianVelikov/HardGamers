...
$res = mysql_query("SELECT id, userid FROM gameplays WHERE id = '$gameplayid'") or sqlerr(__FILE__, __LINE__);	
	...
	<?
		...
		echo "<br/><a href=addGamePlay.php?action=edit&gameplayid=$gameplayid><u>Редактирай</u></a> | <a href=addGamePlay.php?action=delete&gameplayid=$gameplayid><u>Изтрий</u></a></td></tr></table>";
		}
		else{
