...
stdhead("Категория");
	...
	$res = mysql_query("SELECT id, userid, title, youtube, game, body, added FROM  gameplays WHERE game = '$game_id' ") or die (mysql_error());
...
<td style="border:none;">		<?
		...
		?></td>
<td style="border:none;"><a href="viewGamePlay.php?post=<?php echo $row['id']; ?>" style="	text-decoration:none; color: #4f5254; font-size: 18px;"><u><?php echo $row['title']; ?></u></a><br/><?php $string = strip_tags(format_comment($row['body'])); echo substr($string, 0,225); ?>...<br/></td>
</tr>
</table><br/>
	<?php
    }
